...
<html>
  ...
  <div id="app"> 
    ...
    <script type="text/javascript" src="/SpringDemo/js/vue.js"></script>
  <script type="text/javascript" src="/SpringDemo/js/axios.min.js"></script>
   ...
   var app=new Vue({
      ...
      alert(formData);
         axios.post('/SpringDemo/upload/axiosFile',formData).then(function(response){
